<nav class="navbar navbar-expand-md navbar-dark bg-dark perso_size20">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle perso_colorBleurCielMenu" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Contacts
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item perso_colorBleurCielMenu" href="#">Action</a>
                    <a class="dropdown-item perso_colorBleurCielMenu" href="#">Another action</a>
                </div>
            </li>
